...
func TestCredentialStore_DeleteAllForAgent(t *testing.T) {
	...
	cs.AddCredential("ag_test1", "A", "u1", "p1", nil)
	cs.AddCredential("ag_test1", "B", "u2", "p2", nil)
	cs.AddCredential("ag_test2", "C", "u3", "p3", nil)
...
func TestCredentialStore_KeyCorruption(t *testing.T) {
	...
	cs1.AddCredential("ag_test1", "Test", "u", "p", nil)
	cs1.Close()
