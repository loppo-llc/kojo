...
func TestAllowNonOwner_Whitelist(t *testing.T) {
	...
	cases := []struct {
		...
		{http.MethodGet, "/api/v1/agents/ag_x/background-sessions", ag, true},
		{http.MethodGet, "/api/v1/agents/ag_y/background-sessions", ag, false},
		{http.MethodPost, "/api/v1/agents/ag_x/background-sessions", ag, false},
		{http.MethodDelete, "/api/v1/agents/ag_x/background-sessions/groupdm:gd_1", ag, true},
		{http.MethodDelete, "/api/v1/agents/ag_x/background-sessions/groupdm:gd_1/tasks/t1", ag, true},
		{http.MethodDelete, "/api/v1/agents/ag_y/background-sessions/groupdm:gd_1", ag, false},
		{http.MethodGet, "/api/v1/agents/ag_y/background-sessions", guest, false},
