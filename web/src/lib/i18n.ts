...
const messages = {
  ...
  "sched.modeInterval": { ja: "間隔", en: "Interval" },
  "sched.modeCron": { ja: "cron", en: "cron" },
  // Words around the interval selects: en "Every [N] [unit]", ja "[N] [unit] おき".
  "sched.intervalPrefix": { ja: "", en: "Every" },
  "sched.intervalSuffix": { ja: "おき", en: "" },
  "sched.unitMinutes": { ja: "分", en: "minutes" },
  "sched.unitHours": { ja: "時間", en: "hours" },
  "sched.unitDays": { ja: "日", en: "days" },
  "sched.intervalN": { ja: "間隔の数値", en: "Interval value" },
  "sched.intervalUnit": { ja: "間隔の単位", en: "Interval unit" },
